"""Unitree Go2 WebRTC 키보드 제어 예제

간단 사용법:
    python webrtc_move_example.py

기능:
  - WebRTC를 통해 Go2 로봇의 카메라 스트림 수신
  - 실시간 키보드 제어로 로봇 이동
  - 모션 모드 자동 전환 (Normal 모드)
...
def main():
    ...
    asyncio_thread = threading.Thread(
        target=run_asyncio_loop, args=(loop, command_queue)
    )
    ...
    try:
        ...
        while True:
            ...
            cv2.putText(
                img, info, (20, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2
            )
